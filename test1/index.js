...
function showNotes() {
    ...
    notes.forEach((note, id) => {
        ...
        let liTag = `<li class="note my-2 mx-2">
                        <div class="details">
                            <p style="color:cyan">${note.title}</p>
                            <span style="color:wheat">${filterDesc}</span>
                        </div>
                        <div class="bottom-content">
                            <span style="color:lightcyan">${note.date}</span>
                            <div class="settings">
                                <i onclick="showMenu(this)" class="uil uil-ellipsis-h" style="color:white"></i>
                                <ul class="menu">
